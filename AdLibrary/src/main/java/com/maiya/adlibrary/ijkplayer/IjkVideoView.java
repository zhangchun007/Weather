...
import com.maiya.adlibrary.ad.AppHandlerUtil;
...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        @Override
        public void onSurfaceChanged(IRenderView.ISurfaceHolder holder, int format, final int w, final int h) {
            ...
            AppHandlerUtil.getBackgroundHandler().post(runnable);
        }
