...
*
* */
class AdvBannerMaterialView @JvmOverloads constructor(
    ...
    private val mediaView: IMediaView = object : IMediaView {
        ...
        override fun showAsStyle(
            ...
            val origin: IMediaView? = super@AdvBannerMaterialView.getMediaView()
    ...
    fun loadAd(){
        setPageType(AdConstant.SLOT_BANNERTOP)
        AdUtils.showIcon(AdConstant.SLOT_BANNERTOP,getActivity(),this)
    }

    override fun getCloseView(): View = findViewById(R.id.banner_ad_close)
    override fun getLayoutId(): Int {
        return R.layout.adv_material_view_banner_ad
    }
}