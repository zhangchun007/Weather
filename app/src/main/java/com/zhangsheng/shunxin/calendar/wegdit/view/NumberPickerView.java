...
public class NumberPickerView extends View {
    ...
    private void respondPickedValueChangedInScrolling(int oldVal, int newVal) {
        mOnValueChangeListenerInScrolling.onValueChangeInScrolling(NumberPickerView.this, oldVal, newVal);
    }
    ...
    private void onScrollStateChange(int scrollState) {
        ...
        if (mOnScrollListener != null) {
            mOnScrollListener.onScrollStateChange(NumberPickerView.this, scrollState);
        }
    }
    ...
    private void drawLine(Canvas canvas) {
        if (mShowDivider) {
            ...
            canvas.drawLine(getPaddingLeft() + mDividerMarginL,
                    0, mViewWidth - getPaddingRight() - mDividerMarginR, 0, mPaintDivider);
            canvas.drawLine(getPaddingLeft() + mDividerMarginL,
                    getHeight(), mViewWidth - getPaddingRight() - mDividerMarginR, getHeight(), mPaintDivider);
