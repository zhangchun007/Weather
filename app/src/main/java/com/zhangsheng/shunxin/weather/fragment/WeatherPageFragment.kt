...
//import kotlinx.android.synthetic.main.page_weather_net_error.view.*
...
// */
//class WeatherPageFragment : AacFragment<WeatherPageViewModel>(R.layout.fragment_weather_page),
//    TouchScrollView.OnScrollistener {
//    override val vm: WeatherPageViewModel by inject()
//    override val binding by bindView<FragmentWeatherPageBinding>()
...
//
//        binding.typhoon.setSingleClickListener {
...
//
//
//        binding.cctvImage.setSingleClickListener {
...
//            binding.scrollview.setScrollControl(
//                isControlShow(
...
//            )
//        })
//        vm.weatherData.observe(this, Observer {
...
//                params.height =
//                    getParent().getRootView().nN().measuredHeight - DisplayUtil.dip2px(51f)
...
//                (activity.nN() as MainActivity).getFragment()
//            } else {
//                WeatherFragment()
//            }
//        } catch (e: Exception) {
...
//        if (scrollY > 80) {
//            binding.advWeather24.loadAd(AdConstant.SLOTE_MIXBT24PRE15, AdConstant.SLOT_BIGBTPRE15)
//        }
...
//        loadAd(scrollY)
//        if (shouldLoadInfo() && getAppModel().control.value.nN().swtich_all.listIndex(0).infostream == "1" && !isControl()) {
