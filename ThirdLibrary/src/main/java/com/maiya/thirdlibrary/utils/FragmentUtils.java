...
public final class FragmentUtils {
     ...
     * @param isIncludeSelf True to include the fragment, false otherwise.
     */
    public static void removeTo(final Fragment removeTo, final boolean isIncludeSelf) {
     ...
     */
    public static void setBackgroundColor( final Fragment fragment,
                                           final int color) {
     ...
     */
    public static void setBackgroundResource( final Fragment fragment,
                                              final int resId) {
        View view = fragment.getView();
        if (view != null) {
