...
class ShapeRelativeLayout @JvmOverloads constructor(
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        ...
        config.shape = ta.getInt(R.styleable.ShapeRelativeLayout_shapes, 0)
        config.innerRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_InnerRadius, 0F)
        config.thickness = ta.getDimension(R.styleable.ShapeRelativeLayout_Thickness, 0f)
        config.radius = ta.getDimension(R.styleable.ShapeRelativeLayout_Radius, 0f)
        config.topLeftRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_TopLeftRadius, 0f)
        config.topRightRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_TopRightRadius, 0f)
        config.bottomLeftRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_BottomLeftRadius, 0f)
        config.bottomRightRadius = ta.getDimension(R.styleable.ShapeRelativeLayout_BottomRightRadius, 0f)

        config.startColor = ta.getColor(R.styleable.ShapeRelativeLayout_StartColor, 0)
        config.endColor = ta.getColor(R.styleable.ShapeRelativeLayout_EndColor, 0)
        config.centerColor = ta.getColor(R.styleable.ShapeRelativeLayout_CenterColor, 0)
        config.gradientOrientation = ta.getInt(R.styleable.ShapeRelativeLayout_GradientOrientation, 1)
        config.angle_type = ta.getInt(R.styleable.ShapeRelativeLayout_Angle_type, 0)
        config.centerX = ta.getFloat(R.styleable.ShapeRelativeLayout_CenterX, 0f)
        config.centerY = ta.getFloat(R.styleable.ShapeRelativeLayout_CenterY, 0f)

        config.stroke = ta.getDimension(R.styleable.ShapeRelativeLayout_Stroke, 0f)
        config.strokeColor = ta.getColor(R.styleable.ShapeRelativeLayout_StrokeColor, 0)
        config.paddingLeft = ta.getDimension(R.styleable.ShapeRelativeLayout_PaddingLeft, 0f)
        config.paddingRight = ta.getDimension(R.styleable.ShapeRelativeLayout_PaddingRight, 0f)
        config.paddingTop = ta.getDimension(R.styleable.ShapeRelativeLayout_PaddingTop, 0f)
        config.paddingBottom = ta.getDimension(R.styleable.ShapeRelativeLayout_PaddingBottom, 0f)
        config.bgColor = ta.getColor(R.styleable.ShapeRelativeLayout_BgColor, Color.WHITE)

        config.dashWidth = ta.getDimension(R.styleable.ShapeRelativeLayout_DashWidth, 0f)
        config.dashGap = ta.getDimension(R.styleable.ShapeRelativeLayout_DashGap, 1f)
        config.elevations = ta.getDimension(R.styleable.ShapeRelativeLayout_Elevations, 0f)
        config.isRipple = ta.getBoolean(R.styleable.ShapeRelativeLayout_IsRipple, false)
        config.parameter = ta.getFloat(R.styleable.ShapeRelativeLayout_Parameter, 0.2f)
        config.pressedColor = ta.getColor(R.styleable.ShapeRelativeLayout_PressedColor, 0)
        config.isPress = ta.getBoolean(R.styleable.ShapeRelativeLayout_isPress, false)
        ta.recycle()
    }
