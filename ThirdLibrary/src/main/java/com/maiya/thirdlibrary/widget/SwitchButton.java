...
public class SwitchButton extends View implements Checkable {
    ...
    private boolean clickedChanged = true;
    ...
    public void setChecked(boolean checked, boolean isChangeListener) {
        if (checked == isChecked()) {
            postInvalidate();
            return;
        }
    ...
    private void broadcastEvent() {
        if (onCheckedChangeListener != null && isChangeListener) {
    ...
    public void setChangedEnable(boolean enable) {
        clickedChanged = enable;
    }
