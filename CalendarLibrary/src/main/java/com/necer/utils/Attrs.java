...
public class Attrs {
     ...
     * 默认选中的公历字体颜色周六日
     */
    public int defaultSolarTextColorWeekSixSeven;
    /**
     * 公历日期属性
     * 默认选中的公历字体颜色周六日 当天选中
     */
    public int defaultSolarCheckTextColorWeekSixSeven;
     ...
     * 文字距离中心距离X轴
     */
    public float holidayWorkdayDistanceX;

    /**
     * 节假日日期属性  text
     * 文字距离中心距离Y轴
     */
    public float holidayWorkdayDistanceY;
    /**
     * 节假日日期属性  text
     * 文字的位置
     */
