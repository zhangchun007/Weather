...
public class AttrsUtil {
    ...
    public static Attrs getAttrs(Context context, AttributeSet attributeSet) {
        ...
        attrs.todayunCheckedBackground = ta.getResourceId(R.styleable.NCalendar_todayunCheckedBackground, R.drawable.n_bg_un_checked_today);
        ...
        attrs.defaultSolarTextColorWeekSixSeven = ta.getColor(R.styleable.NCalendar_defaultSolarTextColorWeekSixSeven, ContextCompat.getColor(context, R.color.N_solidCircleColor));
        attrs.defaultSolarCheckTextColorWeekSixSeven = ta.getColor(R.styleable.NCalendar_defaultSolarCheckTextColorWeekSixSeven, ContextCompat.getColor(context, R.color.N_defaultSolarTextColor));
        ...
        attrs.holidayWorkdayDistanceX = ta.getDimension(R.styleable.NCalendar_holidayWorkdayDistanceX, context.getResources().getDimension(R.dimen.N_holidayWorkdayDistance));
        attrs.holidayWorkdayDistanceY = ta.getDimension(R.styleable.NCalendar_holidayWorkdayDistanceY, context.getResources().getDimension(R.dimen.N_holidayWorkdayDistance));
        ...
        attrs.todayCheckedWorkdayTextColor = ta.getColor(R.styleable.NCalendar_todayCheckedWorkdayTextColor, ContextCompat.getColor(context, R.color.N_workdayTextColor));
